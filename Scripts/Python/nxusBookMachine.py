...
class nxusBookMachine(ptModifier):
    ...
    def OnServerInitComplete(self):
        ...
        if entryelo is not None:
            entryeloValue = entryelo.getValue()
            if entryeloValue == "yes":
            ...
            PtDebugPrint("nxusBookMachine.OnServerInitComplete(): chron says no link to public Elonin yet. Explore a bit more!")
